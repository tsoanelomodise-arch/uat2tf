        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end flex-wrap gap-3">
              <a href="https://x.com/SATransformFund" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all" title="Follow us on X (Twitter)">
              ...
              <a href="https://www.youtube.com/@SATransformationFund" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all" title="Subscribe to our YouTube channel">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
